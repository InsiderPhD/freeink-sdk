...
class InputManager {
 public:
  ...
  // CPU frequency. Home-key contacts count because they never surface as screen
  // contacts, and without them a session driven only by the home pad resets no
  // idle timer and sleeps under the user's finger. False on non-touch boards.
